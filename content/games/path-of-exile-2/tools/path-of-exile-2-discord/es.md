---
title: "Path of Exile 2 Official Discord"
description: "Servidor oficial de Discord para Path of Exile 2 — anuncios oficiales, presencia de devs y discusión community."
quickTake: "Cuando GGG anuncia un patch, hotfix o cambio crítico, el Discord oficial es donde aparece primero — antes que reddit, antes que Twitter. Para news rápidas y dev interaction, vale la pena estar."
---

## Qué es

El servidor oficial de Discord de Path of Exile 2 (`discord.com/invite/pathofexile2`) es el hub community oficial mantenido por Grinding Gear Games. Tiene canales dedicados a announcements, build discussion, trading help, technical support, y cobertura por idiomas (English, Spanish, Português, etc.).

A diferencia del Discord general de Path of Exile (`discord.com/invite/pathofexile`, que cubre PoE 1 y 2 juntos con 250k+ miembros), el de PoE 2 está focalizado en el juego nuevo, con lo cual la información es más targeted.

## Qué problema resuelve

PoE 2 está en Early Access — patches frecuentes, hotfixes, balance changes, eventos comunitarios. Estar al día implica chequear reddit, Twitter, foros, news sites, cada uno con su propio lag. El Discord oficial colapsa eso: GGG postea announcements directo en `#announcements`, y los responsables del game suelen pasar por canales de discusión respondiendo dudas.

Para players que quieren mantenerse calibrados con el ritmo del juego sin tener que parsear 5 fuentes, ser miembro del Discord oficial es el shortcut.

## Diferenciación

Frente a TFT, el Discord oficial cubre community y news; TFT cubre trading y servicios. Son complementarios — un player serio suele estar en ambos.

Frente a r/pathofexile2 (Reddit), Discord es real-time chat; Reddit es asíncrono y archivado. Para news rápidas, Discord; para discusión profunda con histórico, Reddit.

Frente al Discord combinado de PoE 1 y 2, el dedicado de PoE 2 tiene menos noise — solo conversación de PoE 2, sin distracción del PoE 1.

## Para qué la usa la gente

**Recibir announcements oficiales en real-time**: patches, hotfixes, eventos community, dev posts. Antes que cualquier otra fuente.
...
**El volumen de mensajes en peak hours es brutal**. En patch day o announce de league, los canales se mueven a 10+ mensajes por segundo. Casi imposible seguir conversación sustantiva — útil más para vibe que para info detallada.

**Moderation es voluntaria**. Como cualquier Discord server, hay momentos donde los mods no están y la calidad de discusión cae. Toxicidad ocasional inevitable.
