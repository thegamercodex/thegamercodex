...
Maxroll es un sitio editorial de gaming-guides multi-juego (PoE 1, PoE 2, Diablo 4, Last Epoch, D2R, Lost Ark) operado por un equipo de jugadores top que escribe content original. La sección de PoE 2 (`maxroll.gg/poe2`) cubre desde el league-start guide del patch vigente hasta builds endgame con sus PoB exports, además de planners web propios para passive tree y atlas tree.

A diferencia de wikis colaborativas, Maxroll tiene editorial line: cada guía está firmada por uno o varios autores, revisada antes de publicar, y mantenida con updates explícitos cuando GGG cambia balance.
...
Frente a Mobalytics (su competidor más directo), Maxroll tiene historial más largo en el ecosistema PoE y más profundidad editorial: las guías son más detalladas y los autores son creators conocidos. Mobalytics gana en breadth (más builds del community) y en herramientas como tier list / build tracker integrado.

Frente a poe.ninja (que da data agregada sin opinión), Maxroll es la versión opinada: cada guía representa la opinión informada del autor, con reasoning explícito de por qué tal item, tal nodo, tal skill. Maxroll te dice qué hacer; poe.ninja te dice qué hacen los otros.

## Para qué la usa la gente

**Elegir build de league start**: días previos al lanzamiento de un patch, Maxroll publica su tier list con builds rankeadas por viability, ease of leveling, budget. Sirve como filtro inicial frente a las decenas de builds que postean creators.
...
**News y patch breakdowns**: cobertura editorial de cada announce de GGG con análisis de qué cambió y qué builds gana o pierde.
...
**Solo está en inglés**. No hay localización. Términos técnicos (cluster jewels, anointments en PoE 1 vs equivalents en PoE 2, etc.) requieren manejo del vocabulario.

**El editorial bias favorece builds populares**. Una build que el equipo no juega o no testeó internamente probablemente no aparezca en tier list. Esto evita relleno pero también deja afuera builds nicho viables.
