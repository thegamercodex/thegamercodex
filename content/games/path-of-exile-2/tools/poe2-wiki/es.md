...
Path of Exile 2 Wiki (`poe2wiki.net`) es la wiki community-driven dedicada a PoE 2, hermana del PoE 1 Wiki (`poewiki.net`). La mantiene la misma comunidad de editores que sostiene la wiki de PoE 1 desde hace años, con artículos sobre clases, ascendancies, skills, items, mecánicas, lore y guías estructurales.

Es un proyecto independiente de GGG pero con cobranding aceptado y respaldo via Discord oficial. Funciona sobre MediaWiki, lo que lo hace familiar para cualquiera que haya navegado Wikipedia o wikis de juegos.
...
1. Vas a `poe2wiki.net`. Home tiene navegación destacada: Classes, Skills, Items, Mechanics, Areas.
...
**Cobertura desigual**. PoE 2 está en Early Access; algunas páginas son muy completas (clases, skills core), otras esqueléticas (ciertos uniques o mecánicas recientes). La wiki crece según contribución community.

**Solo en inglés**. Sin localización al español. La wiki de PoE 1 (poewiki.net) tiene algunos contenidos en otros idiomas; PoE 2 todavía es solo inglés en esta etapa.

**Lag post-patch**. Cuando GGG cambia algo, la wiki tarda en actualizarse — depende de que un editor haga el cambio. Para data exacta post-patch, PoE2DB es más rápido.

**Discrepancias ocasionales con el juego**. A veces números o descripciones quedan desactualizados. Si un dato es crítico para tu build, cruzarlo con PoE2DB o el game files.

**Diseño funcional, no moderno**. MediaWiki estándar — eficiente para consultar, no espectacular visualmente.
