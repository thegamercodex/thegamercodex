...
**Antes de jugar**, abres **Aim Botz** —el mapa de workshop estándar— para calentar el aim y trabajar el control de spray un par de minutos. Es la rutina que casi todos los jugadores serios hacen antes de su primera partida del día.

**Después de jugar**, **Leetify** hace el trabajo pesado: analiza tu partida automáticamente y te dice en qué estás flojo —reaction time, utility, trades, posicionamiento— comparándote contra rangos superiores. Para ir más profundo en una partida específica, **Scope.gg** te deja revisar la demo con heatmaps y análisis ronda por ronda, ideal para entender un patrón que se repite.
...
- **Calentamiento y práctica de aim** → Aim Botz
- **Diagnóstico automático** → Leetify
