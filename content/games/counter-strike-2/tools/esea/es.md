...
ESEA (E-Sports Entertainment Association) es una de las plataformas competitivas más antiguas del ecosistema Counter-Strike. Operó desde 2003 como third-party con su propio anti-cheat client (ESEA Client) y formato de ligas por temporada con divisiones (Open, Intermediate, Main, Premier).

Históricamente fue la plataforma serious de NA — escena pro y semi-pro pasaba por ESEA Premier antes de ser equivalente al circuito profesional. Tenía ranking individual visible, prize pools en seasons y un anti-cheat con reputación de fuerte.

En 2019 fue adquirida por **FACEIT** (que ya era su competencia directa), y desde 2022 ambas son parte de **ESL FACEIT Group**. Operacionalmente ESEA quedó relegada — la mayoría del foco corporativo y de la base activa de jugadores migró a Faceit, mientras que ESEA mantiene principalmente sus ligas estructuradas y una base legacy de usuarios que prefieren ese formato.

El modelo es de **subscripción paga** desde siempre (~12 USD/mes históricamente; las tiers actuales pueden variar). Esto la diferencia de Faceit, donde el matchmaking básico es free.
...
Para casi cualquier otro caso (matchmaking serio cotidiano, anti-cheat fuerte, queue rápida, base masiva), Faceit la superó hace años.
...
**Equipos amateur con coaching estructurado**: ESEA tiene tradición de equipos organizados que practican y compiten en seasons — algunos siguen ese formato.

**Cobertura NA específica**: en NA mantiene presencia notable comparado con otras regiones donde Faceit es dominante.

## Para quién NO es esta herramienta

ESEA es excelente para legacy y ligas estructuradas pero no es:

- **Para empezar CS2 competitivo en 2025-2026** → Faceit es la default para la mayoría de regiones y casos.
- **Para matchmaking instant queue** → ESEA está más enfocada en ligas que en MM persistente. Las queues de "PUG" están vivas pero la base es chica.
- **Para evitar pagar suscripción** → ESEA siempre fue paywall. Si te molesta pagar para jugar, Faceit free es la alternativa.
- **Para regiones fuera de NA/EU** → la base activa fuera de NA y EU central es muy chica.
...
**Corporate consolidation**: misma compañía controla ESEA y Faceit. Esto reduce diferenciación real entre las dos plataformas — son productos distintos del mismo dueño.

**UX dated**: el sitio se siente legacy. Funcional pero no moderno.

**Linux/Mac sin soporte oficial**: similar a Faceit, el client es Windows-first.

## Cómo empezar

1. Crear cuenta en `play.esea.net` y conectar Steam.

2. Subscribir a tier paga (~12 USD/mes, verificar pricing actual).

3. Instalar **ESEA Client** (Windows).
