---
title: "CSGOSTASH"
description: "Database de referencia de skins de CS2 con catálogo completo organizado por colección y case, precios históricos, comparativas de wear y información de stickers compatibles."
quickTake: "No es marketplace activo — es la enciclopedia de skins. Si vas a investigar antes de comprar (precios históricos, wear comparisons, qué case dropea qué), csgostash es donde se hace la tarea."
---
...
Comprar skins informadamente requiere context que ningún marketplace expone bien:
...
**Investigar precio antes de comprar**: ver si la skin está cara comparada con histórico o si es buen momento de compra.

**Comparar wears**: decidir si pagar más por Factory New tiene sentido visualmente o si Field-Tested ahorra significant sin perder estética.

**Entender qué dropea cada case**: ante un nuevo case en el juego, ver el contenido completo y odds antes de gastar keys.
...
1. Vas a `csgostash.com`. La home muestra cases recientes, drops nuevos, y search prominent.

2. Para investigar una skin específica: search por nombre. La página de skin muestra: imagen en wears variados, slider de wear range, precio histórico extendido, stickers compatibles, drop sources.

3. Para investigar una collection completa: navegación lateral por **Cases**, **Souvenir Packages**, **Operations**, **Stickers**.

4. Para investigar un sticker: search en sticker section. Páginas individuales con applied price (precio de stickered weapon vs unstickered), capsule de origen y rarity.

5. Para precio cross-platform: csgostash agrega referencias de Steam, CS.MONEY y otros — útil para ver spread.

## Limitaciones honestas

**No es marketplace, hay que ir a otro lado para transactionar**: a veces la friction de "investigué acá pero ahora tengo que ir a Steam" es real. Para usuarios que quieren hacer todo en un sitio, esto no funciona.

**Precios pueden tener lag**: la data se agrega de varios sources con frecuencia razonable pero no real-time. Para timing tight, Steam Market es la verdad.

**Cobertura desigual de items muy nichos**: items super raros (extreme floats, patterns únicos) pueden no estar bien documentados.

**UX dated en partes**: el sitio tiene parches de evolución visible. Funcional pero no moderno.

**Ads notables en versión free**: no tiene tier paga; monetización es solo ads + affiliates. Adblocker resuelve la mayoría.

**No tiene tracking de tu propia inventory**: csgostash no se conecta a tu Steam. Es read-only del catálogo, no portal personal.
...
5. Para cases nuevas, la página del case en csgostash es "single source of truth" rápido — todos los items dropeables y odds en una vista.

6. Para skins extremas (>$1000 USD), no confiar solo en csgostash — buscar también en r/csgomarketforum y verificar con dealers conocidos.
