...
El No Man's Sky Wiki es la enciclopedia comunitaria del juego, alojada en Fandom (antes Wikia) y mantenida por miles de editores voluntarios desde 2016. Tiene varios miles de páginas cubriendo prácticamente todo lo que aparece en el juego: items, recetas, technologies, ships, multi-tools, freighters, fauna procedural documentada por jugadores, planetas notables, civilizaciones de jugadores y patches históricos.

Es completamente gratis y editable por cualquiera con cuenta de Fandom. La interfaz incluye anuncios — Fandom monetiza con ads — pero no hay paywall ni cuenta paga. Está disponible en inglés (versión principal con mayor cobertura) y otras versiones en idiomas como ruso, alemán o español, aunque las traducidas suelen estar incompletas o desactualizadas.

## Qué problema resuelve

Para preguntas que requieren contexto narrativo o histórico, Assistant y otros companion apps no alcanzan. ¿Qué hacía la mecánica de Atlas Stone que removieron en NEXT? ¿Cuándo se introdujeron los freighters? ¿Cómo funcionaba la economía antes de Origins? ¿Qué es exactamente Polo y por qué importa? El wiki tiene esas respuestas con citas de patches y discusión de cambios.

También cubre detalles enciclopédicos que rara vez aparecen en companion apps: variantes raras de fauna, mecánicas de Pirate Sentinels, lista completa de finales del Atlas Path, easter eggs en arquitectura procedural, símbolos de glyphs traducidos.

## Diferenciación

Frente a **Assistant for No Man's Sky**: Assistant es para uso operativo durante el juego (recetas, refinería, eventos en vivo). El wiki es para contexto enciclopédico. No compiten — los jugadores serios usan ambos.

Frente a **NMSCD**: NMSCD agrega tools comunitarias activas; el wiki es contenido textual estático. Distintos roles.

Frente a buscar en Reddit: Reddit es bueno para preguntas frescas sobre patch nuevo o opiniones; el wiki es bueno para datos canónicos verificables.
...
**Comparar items con otras versiones históricas**: cuando un patch cambia un item, el wiki suele dejar el changelog.

**Encontrar civilizaciones de jugadores**: existe una sección dedicada a civilizations creadas por la comunidad (Galactic Hub, Federation, etc.) con sus reglas, miembros y coordenadas oficiales.
...
**Anuncios pesados**. Fandom monetiza con ads grandes y video autoplay. La experiencia mobile es particularmente ruidosa.
