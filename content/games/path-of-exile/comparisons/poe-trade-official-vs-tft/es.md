...
Ambos son herramientas centrales para tradear en PoE, pero cubren spectrums distintos. **El sitio oficial** (pathofexile.com/trade) es el web app de GGG para listing y búsqueda de ítems individuales con filtros granulares. **TFT (The Forbidden Trove)** es el servidor de Discord más grande de PoE, donde la comunidad gestiona bulk trading, services, mirror tier crafts, y todo lo que el sitio oficial no soporta bien.
...
- **Bulk currency exchange**: comprar 1000 chaos por 10 div, vender 50 div por X. Hay canales con bots de pricing que muestran tipos de cambio actuales y matchean listings rápido.
- **Service marketplace**: alguien te lleva al Uber Maven, levelea tu personaje del 1 al 95, te corre 10 mapas de un farming layout específico, te craftea un ítem con bench secuence complejo.
- **Mirror-tier items**: ítems de millones de divs no se listan en trade público; se negocian en TFT con reputación, screenshots, y procesos verificados.
- **Headhunter swaps, leveling sets, body armour transfers**: trades por escencia más que por valor monetario, comunes en early league.
...
Acá TFT no tiene competencia. Tiene un **sistema de reputación** con verificación por moderadores: traders confiables tienen rep visible, los scammers se bannean, hay un dispute resolution process activo. Para trades de alto valor (mirror crafts, items de millones), esto es lo que hace viable la transaction. El sitio oficial no tiene sistema de rep; cada trade individual es entre desconocidos.

Para servicios pagos (carries, levelings), TFT es el hub donde se concentra el oferta y demanda. Hay canales dedicados con guidelines de pricing y reviews. Esto es contenido que el sitio oficial no soporta y que en otros servers más chicos sería más riesgoso.
