---
title: "Genshin Impact Discord (official)"
description: "Official Discord for Genshin Impact covering announcements, LFG, and discussion."
quickTake: "The first-party hub for Genshin Impact. Official announcements and bug reports go through here before anywhere else."
---

## What it is

It's the official Genshin Impact Discord server, maintained by the game team. With 1 million+ members, it's the central communication hub between the team and the global community.
...
As an official server, patch announcements, hotfixes, compensations, and special events appear here first, before social media or the official website.
...
- **Bug reports and feedback**: dedicated channel where reports reach the dev team.
...
1. Click `https://discord.com/invite/genshinimpact` and sign in with your Discord account.
2. Quick verification (some servers require initial interaction — read rules, react for access).
3. Configure per-channel mutes so you don't get pinged by 50 channels at once.
4. Subscribe to #announcements and #patch-notes for critical info.
5. For LFG and support, use the specific channels following the server's rules.
...
- **Editorially-slanted moderation**: deep game criticism may be moderated.
- **English only**: main channels are in English.

## How to get started

Have a Discord account. Click `https://discord.com/invite/genshinimpact`, complete verification, configure notifications (recommended: mentions only + announcements channel). Bookmark the invite in case you need to resend it.
