...
Ishtar Collective es un archivo open-source del lore de Destiny 2 mantenido por una pequeña comunidad de fans. Free, sin ads pesados, sin login. Donaciones opcionales. Activo desde 2015 (cubre desde D1 con secciones marcadas, pero el foco vigente es D2 desde 2017).

Cubre cada lore card del juego (cientos, posiblemente miles), transcripciones completas de cinemáticas, dialogues de NPCs, descripciones de items con texto narrativo, y secuenciación cronológica que arma narrativas coherentes a partir de los fragmentos dispersos. Filtros por personajes, eventos, races, y arcos narrativos.
...
**Verificar referencias de creators**: cuando un video de lore menciona "el Vex en Quria descubrió X", Ishtar te muestra la card original con cita exacta.

**Investigar personajes específicos**: timeline completo de un NPC desde su primera aparición hasta la última. Útil para entender arcos narrativos largos.

**Preparación pre-expansión**: antes de jugar campaña nueva, refrescar el lore de los personajes que van a aparecer. Lighting de referencias casuales se vuelve perceptible.

**Theorycrafting de eventos futuros**: la comunidad usa Ishtar para teorías sobre próximas expansiones — qué se está set up, qué references hay a personajes/eventos no resueltos.

**Lectura recreativa**: algunos jugadores leen Ishtar como literatura. Las lore cards de Destiny son short-form fiction de calidad sorprendente; el archivo permite consumir como antología.
...
**No cubre toda audio dialogue**. Algunos NPCs hablan in-game pero el dialogue no está siempre transcripto. Las cinemáticas están mejor cubiertas.
