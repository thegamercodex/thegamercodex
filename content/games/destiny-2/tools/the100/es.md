---
title: "The100.io"
description: "Plataforma LFG con scheduling y comunidades persistentes para Destiny 2: raids, dungeons y endgame."
quickTake: "El LFG con horario en lugar de instant queue. Ideal para adultos con tiempo limitado que prefieren reservar el slot del jueves a las 8pm en lugar de azar."
---

## Qué es

The100.io es una plataforma de LFG (Looking for Group) para Destiny 2 con foco en **scheduling**: en lugar de queue instantánea, los jugadores postean activities con día/hora específica, y otros jugadores aplican para reservar slot. Free con tier premium opcional. Web + apps mobile (iOS, Android). Activa desde 2014, originalmente solo D1.

Cubre todas las actividades cooperativas que requieren más de 3 jugadores (raids 6-man, dungeons 3-man pero con búsqueda de fireteam serio, GMs, etc.). Tiene también el concepto de "groups" — comunidades persistentes que se juntan regularmente con miembros conocidos.
...
Frente al Fireteam Finder oficial in-game (lanzado en 2024 con The Final Shape), The100.io gana en **scheduling y experiencia de comunidad**. Fireteam Finder es instant queue similar a otros LFG; The100 ofrece groups persistentes, scheduling con hours específicas, y filtro por experience.
...
**Carries y sherpa runs explícitos**: fireteam leads que ofrecen carry o sherpa lo postean explícitamente, los aplicantes saben qué expectations tener.

**Cross-platform LFG**: Destiny 2 es crossplay; The100 te deja filtrar o no por plataforma según preferencia.
...
**Curva de uso más alta que LFG instant**. Setting up un perfil, escribiendo posts y filtrando aplicantes toma tiempo que Fireteam Finder oficial no requiere.
...
**Solo cooperativo PvE primariamente**. PvP coverage existe pero es menor — para Trials, otros canales son mejores.
