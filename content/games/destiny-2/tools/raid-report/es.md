...
Raid Report es un sitio web especializado en una sola cosa: mostrar stats granulares de raids y dungeons de Destiny 2. Free, monetizado por ads, sin login obligatorio. Activo desde 2017 y mantenido continuamente — siempre soporta la raid o dungeon más reciente desde el día uno.

Cubre todas las raids y dungeons del juego (incluyendo las que ya no están rotando), separadas por dificultad (normal, master, contest) cuando aplica. Para cada actividad y jugador, calcula completions totales, fastest run, sherpas (clears con first-timers), y solo flawless cuando aplica.
...
Frente a Destiny Tracker (que también muestra stats), Raid Report está **enfocado quirúrgicamente**: solo raids y dungeons. Por eso muestra info que Destiny Tracker no tiene: sherpas, contest mode clears, low-man stats, fastest run details. Si tu pregunta es "qué tan bueno es este jugador en raids", Raid Report > Destiny Tracker.

Frente a la pestaña Career oficial, Raid Report gana en granularidad y velocidad. Career muestra el número total; Raid Report te muestra desglose por dificultad y contexto (sherpa, flawless, low-man).
...
**Solo raids y dungeons**. Para Trials, GMs, otras actividades — no es la fuente. Cada actividad endgame tiene su tracker más especializado.

**Depende de profile público**. Bungie permite ocultar la career; si el jugador lo hace, Raid Report muestra mensaje de "private". No es bug, es respeto a privacidad.

**No mide skill**. Solo mide completion count. Un jugador con 100 clears no es necesariamente bueno en mecánicas — sólo persistente. Para juzgar skill, sherpa count y fastest time son señales más útiles.
