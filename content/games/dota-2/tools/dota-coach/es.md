...
Dota Coach es una app de desktop que corre sobre Overwolf y provee guías in-game para cada uno de los 124 héroes de Dota 2. Se diferencia de otros agregadores de guías por estar mantenida por coaches profesionales de Dota 2 que actualizan continuamente el contenido con conocimiento propietario. El equipo afirma tener 1,250+ tips específicos y combos de items y habilidades para cada héroe del juego.

La app corre como overlay de Overwolf durante tu partida: en el loading screen muestra la build del héroe que seleccionaste, durante el match expone tips contextuales (ej "Roshan respawn en ~3 minutos", "buen momento para empujar lane 2", "cuidado con el farm timing del héroe X"), y al final del match ofrece review breve de jugadas clave.

El tier gratis cubre la mayoría de la experiencia. Hay una suscripción Premium (~$4-5/mes) que desbloquea features avanzadas como análisis AI detallado, creación de builds personalizadas y acceso sin ads. Para la mayoría de usuarios el tier gratis alcanza.
...
**Roshan timing y objetivos importantes**: la app trackea el respawn time de Roshan y expone alertas cuando es probable que respawnee. Mismo para runas, Outposts y neutral items importantes.

**Análisis post-match breve**: al final de cada match la app muestra resumen de momentos clave y áreas sugeridas para mejorar. Menos profundo que TrueSight (Dotabuff Plus), pero gratis.

**Visualización de skill order y habilidades de teammates y oponentes**: el loading screen muestra la build típica de cada héroe del match, útil para entender qué esperar del enemigo.

## Para quién NO es esta herramienta

Dota Coach es excelente para muchos jugadores pero no para todos:
...
2. Desde el app store de Overwolf, instalar Dota Coach.

3. Lanzar Dota 2 normalmente. Dota Coach se activa automáticamente en el loading screen.

4. Durante el loading screen, revisar la build de tu héroe y los héroes de teammates/oponentes.

5. Durante el match, la app expone tips contextuales en un corner de la pantalla (configurable). Algunos son notificaciones visuales, otros audio si está activado.
...
1. Verificar que estés en Windows. Si no, esta no es la tool — probar DotaPlus by Overwolf u otra alternativa.

2. Instalar Overwolf desde `overwolf.com`. Instalación rápida.

3. Abrir el app store de Overwolf y buscar "Dota Coach". Instalar.

4. Abrir Dota 2. El primer match Dota Coach se activa y verás la interfaz de bienvenida.

5. Jugar 2-3 matches con la configuración default para sentir la experiencia.
