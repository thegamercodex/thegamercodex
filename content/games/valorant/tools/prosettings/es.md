...
Prosettings.net es un sitio dedicado a documentar configuraciones de pros de FPS competitivos. Free, monetizado por ads y links de afiliados, sin login. Activo desde 2014 (pre-Valorant), con cobertura sólida de Valorant desde 2020. Equipo editorial mantiene las pages.

Para cada pro relevante, una página con: sensitivity, DPI, polling rate, eDPI calculation, mouse modelo, monitor modelo y refresh rate, video settings (resolución, FOV, ratio), keybinds, headset, mousepad, y crosshair code. Actualizado vía interviews directas con pros, streams o sus tweets.
...
Frente a ValorantCC, Prosettings es **completo**. ValorantCC solo crosshairs; Prosettings es config integral.

Frente a páginas oficiales de pros (twitter, twitch about), Prosettings consolida en formato consistente. Cada pro page tiene la misma estructura, fácil de comparar.

Frente a inputlag.com o rtings.com (sites técnicos de hardware), Prosettings es desde el ángulo "qué usan los pros", no testing técnico independiente.
...
**Tracking de cambios**: si un pro cambia sensitivity, Prosettings updatea (con delay). Útil para ver cuándo y por qué un pro ajusta.

**Tier list de mice/monitores entre pros**: % de pros usando cada mouse model. Para gaming gear research, métrica útil.
...
5. Para tier de hardware: secciones "Most Used Mice", "Most Used Monitors", etc.

## Limitaciones honestas

**Updates dependen de fuentes externas**. Cuando un pro cambia setup sin avisar, Prosettings tarda en reflejar. La info puede estar 2-4 semanas atrás de la realidad.

**Cobertura desigual entre regiones**. NA y EMEA muy completos; LATAM, APAC, JP menos.
