---
title: "Valorant Discord (community)"
description: "Main community Discord for Valorant covering announcements, LFG, and discussion."
quickTake: "The biggest community Discord for Valorant. Not first-party but it's where the conversation concentrates when the dev doesn't run an official server."
---

## What it is

It's the VALORANT Discord, community Discord with hundreds of thousands of members. Although the game's publisher doesn't maintain a global official Discord, this server works as the de-facto hub for the community: general discussion, LFG, peer support, and reactions to game changes.
...
1. Click `https://discord.com/invite/valorant` and sign in with your Discord account.
...
Have a Discord account. Click `https://discord.com/invite/valorant`, complete verification, configure notifications (recommended: mentions only + announcements channel). Bookmark the invite in case you need to resend it.
