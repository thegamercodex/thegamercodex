...
description: "Plataforma de stats de Valorant con match history, leaderboards globales y desglose por agente y mapa."
quickTake: "El tracker default de Valorant. Stats amplios, comparativas con la comunidad y match history detallado — útil para todo, no especializado en nada."
---

## Qué es

Tracker.gg es la pieza de Valorant dentro de Tracker Network, un grupo de sitios de stats que cubre múltiples FPS (Apex, Valorant, CS2, Fortnite). Free, web-only, monetizado por ads y tier premium opcional. Activo desde el lanzamiento de Valorant en 2020.

Cubre lo esperable: stats globales del jugador, K/D por modo, win rate por agente y mapa, match history detallado con per-round info, leaderboards globales y comparativas porcentiles. Integración a la API pública de Riot.
...
Frente a Blitz.gg, Tracker.gg gana en **amplitud de cobertura comunitaria** (leaderboards globales son más completos) y se queda atrás en **integración overlay** (Blitz tiene un cliente desktop que muestra info en partida, Tracker.gg no).

Frente a Valorbuff, Tracker.gg tiene mejor UI y datos más profundos en stats por mapa; Valorbuff es más liviano y rápido para lookup express.

La regla práctica: Tracker.gg para análisis profundo de tu carrera, Blitz para overlay activo en partida, Valorbuff para lookup rápido sin clutter.
...
**Tracking de progreso ranked**: gráfico de RR por act muestra tendencia. Reality-check cuando "siento que estoy mejorando".
...
Si Riot privatizó tu perfil, Tracker.gg no muestra nada — Riot permite ocultar career por configuración del cliente.
...
**Ads moderados**. Sin adblock, mobile experience puede ser lenta. En desktop con uBlock, navegable.

**Algunos stats laggean al patch**. Cuando Riot suelta un patch grande con balance, las comparativas tardan días en reflejar la nueva meta.

**No tiene replay analysis**. Para revisar partidas con time-stamping y annotations, Insights.gg es la herramienta correcta.
