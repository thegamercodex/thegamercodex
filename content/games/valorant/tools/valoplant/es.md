---
title: "Valoplant"
description: "Herramienta de strat planning para Valorant con mapas dibujables, lineups database y export para shareo con team."
quickTake: "Para cualquier squad serio (premade competitivo o team scrimmeando), Valoplant es donde se planifican strats. Mapas drawables tipo whiteboard + database de utilities populares."
---
...
Frente a Mobalytics lineup database, Valoplant gana en **strat planning interactivo**. Mobalytics tiene grid de lineups; Valoplant te deja DIBUJAR el strat completo combinando lineups con posicionamiento.

Frente a Valorantmaps (callout-focused), Valoplant es más estratégico — Valorantmaps es info estática (qué se llama qué), Valoplant es planning dinámico.

Frente a Discord whiteboard apps, Valoplant es Valorant-específico — mapas precisos, lineups built-in, no toolkit genérico.

## Para qué la usa la gente

**Squads competitivos planifican strats**: equipos de Premier o ligas amateur dibujan strats, los guardan, y los repasan pre-scrim. Workflow estándar para teams serios.
...
**Curva de aprendizaje**. La interfaz tiene muchas opciones; aprender a usar el toolkit lleva tiempo. Para casuals que querían "ver una lineup" es overkill.

**Premium pushy en features avanzadas**. Strats ilimitados guardados, advanced features están detrás del paywall. Free tier suficiente para uso individual o team chico.

**Cobertura de mapas a veces lagea al pool oficial**. Cuando Riot rota un mapa back en, Valoplant puede tardar días en agregarlo.

**Lineup database depende de submissions**. Mapas viejos están bien cubiertos; nuevos pueden estar sparse.
