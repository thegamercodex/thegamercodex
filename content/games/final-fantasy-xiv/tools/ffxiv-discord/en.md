---
title: "Final Fantasy XIV Discord (community)"
description: "Main community Discord for Final Fantasy XIV covering announcements, LFG, and discussion."
quickTake: "The biggest community Discord for Final Fantasy XIV. Not first-party but it's where the conversation concentrates when the dev doesn't run an official server."
---

## What it is

It's the Final Fantasy XIV Discord, the largest community Discord for FFXIV. Although the game's publisher doesn't maintain a global official Discord, this server works as the de-facto hub for the community: general discussion, LFG, peer support, and reactions to game changes.
...
1. Click `https://discord.com/invite/ffxiv` and sign in with your Discord account.
...
4. Subscribe to #announcements for critical info.
...
Have a Discord account. Click `https://discord.com/invite/ffxiv`, complete verification, configure notifications (recommended: mentions only + announcements channel). Bookmark the invite in case you need to resend it.
