...
export function ToolListItem({
  ...
  return (
    ...
    <Link
      ...
      className={`group grid grid-cols-[auto_1fr] items-center gap-4 rounded-lg border py-3 pl-4 pr-12 transition-all duration-200 hover:-translate-y-0.5 hover:border-[var(--game-accent,var(--color-accent))]/60 hover:bg-muted/70 sm:grid-cols-[auto_1fr_auto] ${
        tool.official
